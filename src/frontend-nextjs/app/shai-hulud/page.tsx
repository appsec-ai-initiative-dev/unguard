...
export default function ShaiHuludPage() {
    ...
    return (
        <div className='p-8 max-w-2xl mx-auto'>
            <h1 className='text-2xl font-bold mb-4 text-amber-700'>🪱 Shai-Hulud Supply Chain Attack Demo</h1>
            ...
            <div className='bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6'>
                ...
                <p className='text-sm text-amber-700 mb-2'>
                    ...
                    <code className='bg-amber-100 px-1 rounded'>@ctrl/tinycolor</code> package. The malicious package
                    harvests secrets and exfiltrates them to an attacker-controlled URL.
                </p>
                <p className='text-sm text-amber-700'>
                    <strong>IoC for Dynatrace:</strong> Outbound HTTP POST with secret data, package metadata in
                    headers, environment/file harvesting.
                </p>
            </div>
            ...
            <div className='bg-slate-100 border border-slate-200 rounded-lg p-4 mb-6'>
                ...
                <ul className='text-sm text-slate-600 space-y-1'>
                    <li>
                        • Set env vars with <code className='bg-slate-200 px-1 rounded'>SAFE_TOKEN_</code> prefix
                    </li>
                    <li>
                        • Or create <code className='bg-slate-200 px-1 rounded'>fake-secrets/</code> dir with token
                        files
                    </li>
                    <li>
                        • Configure <code className='bg-slate-200 px-1 rounded'>CTRL_TINYCOLOR_EXFIL_URL</code> to
                        customize target
                    </li>
                </ul>
            </div>
            ...
            {result && (
                ...
                >
                    <h3 className='font-semibold mb-2'>{result.success ? '✓ Exfiltration triggered' : '✗ Error'}</h3>
