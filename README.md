...
| [mcp-client-service](./src/mcp-client-service)             | Python Flask        | default         | Connects to Dynatrace MCP servers for AI-driven observability insights and enhanced monitoring capabilities.                            |
