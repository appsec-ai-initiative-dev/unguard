...
2. Install MariaDB
   ...
   ```sh
   helm install unguard-mariadb bitnami/mariadb --version 11.5.7 --set primary.persistence.enabled=false --set image.repository=bitnamilegacy/mariadb --wait --namespace unguard --create-namespace
   ```
